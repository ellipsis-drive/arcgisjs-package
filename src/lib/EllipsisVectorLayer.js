...
export default EllipsisVectorLayer = (blockId, layerId, options = {}) => {
    ...
    //    options.style,
    //    options.filter,
    // options.centerPoints = options.centerPoints ? true : false;
    // options.maxZoom = options.maxZoom ? options.maxZoom : 21;
    // options.pageSize = options.pageSize ? Math.max(3000, options.pageSize) : 25;
    // options.maxMbPerTile = options.maxMbPerTile ? options.maxMbPerTile * 1000000 : 16000000;
    // options.maxTilesInCache = options.maxTilesInCache ? options.maxTilesInCache : 500;
    // options.maxFeaturesPerTile ? options.maxFeaturesPerTile : 200;
    // options.radius = options.radius ? options.radius : 15;
